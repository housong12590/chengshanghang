...
import com.jmm.csg.pro.product.adapter.MissionListAdapter;
...
public class MissionListFragment extends BaseRVFragment<Product> {
...
//    private View headerView;
    ...
    protected Observable<List<Product>> getApi(String currNum) {
        return HttpModule.missionList(HttpParams.missionList(UserDataHelper.getUserId(), null))
...
//        ivLogo = (ImageView) headerView.findViewById(R.id.iv_logo);
    ...
    protected BaseRVAdapter<Product> getRecyclerViewAdapter() {
        MissionListAdapter adapter = new MissionListAdapter();
