...
public class EvaluateAdapter2 extends BaseRVAdapter<ProductReview.DataBean.ReviewBean> {

    public EvaluateAdapter2() {
        super(R.layout.item_evaluate_layout);
    }

//    public EvaluateAdapter2(List<ProductReview.DataBean.ReviewBean> data) {
