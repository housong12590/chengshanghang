...
public class LoadingAndRetryManager {
    ...
    public static int BASE_LOADING_LAYOUT_ID = R.layout.loader_base_loading;
    public static int BASE_RETRY_LAYOUT_ID = R.layout.loader_base_retry;
    public static int BASE_EMPTY_LAYOUT_ID = R.layout.loader_base_empty;
